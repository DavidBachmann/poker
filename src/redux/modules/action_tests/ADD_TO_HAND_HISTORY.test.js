import reducer, { ADD_TO_HAND_HISTORY } from '../gameManager'

test('Add game to hand history', () => {
  let state
  state = reducer(
    {
      pot: 3030,
      ...
      handWinners: [
        {
          ...
          handDetails: {
            cardPool: [
              { value: 'Q', suit: 'c', rank: 11, wildValue: 'Q' },
              { value: 'Q', suit: 'h', rank: 11, wildValue: 'Q' },
              { value: '9', suit: 'c', rank: 8, wildValue: '9' },
              { value: '9', suit: 'h', rank: 8, wildValue: '9' },
              { value: '8', suit: 'd', rank: 7, wildValue: '8' },
              { value: '6', suit: 'c', rank: 5, wildValue: '6' },
              { value: '5', suit: 'd', rank: 4, wildValue: '5' },
            ],
            cards: [
              { value: 'Q', suit: 'c', rank: 11, wildValue: 'Q' },
              { value: 'Q', suit: 'h', rank: 11, wildValue: 'Q' },
            ...
            game: {
              descr: 'standard',
              cardsInHand: 5,
              handValues: [null, null, null, null, null, null, null, null, null],
              wildValue: null,
              wildStatus: 1,
              wheelStatus: 0,
              sfQualify: 5,
  ...
  expect(state).toEqual({
    ...
    communityCards: {
      ...
      '1': [{ rank: { value: 12, symbol: 'Q' }, suit: { symbol: '♥', letter: 'h', color: 'red' } }],
      '2': [{ rank: { value: 9, symbol: '9' }, suit: { symbol: '♥', letter: 'h', color: 'red' } }],
    },
    nextPlayerToAct: -1,
    whatPlayerIsDealer: null,
    highestCurrentBettor: {
