import reducer, { PLAYER_BETS } from '../gameManager'

test('Player is first to act and bets 255', () => {
  let state
  state = reducer(
    {
      pot: 0,
...
test('Player bets an astronomical amount and is instead put all-in', () => {
  let state
  state = reducer(
    {
      pot: 0,
